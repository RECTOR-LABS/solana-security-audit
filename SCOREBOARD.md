...
6. **Repo must NOT be archived** (upstream PR required)

## Eliminated Findings

The following findings from `solana-program-library` (solana-labs) were eliminated because the repo is **archived** (March 2025) — no upstream PRs possible:
...
| 2 | OpenBook v2 | Unchecked i64 arithmetic in order matching | 3 | 2 | 2 | 2 | 3 | **144** | found |
| 3 | Anchor | CPI Return<T> unvalidated program ID in return data | 3 | 5 | 2 | 2 | 2 | **120** | found |
| 4 | MarginFi v2 | Token-2022 transfer hook compatibility gap | 4 | 2 | 3 | 2 | 2 | **96** | found |
| 5 | MarginFi v2 | Switchboard oracle missing round_open_slot check | 3 | 2 | 2 | 2 | 3 | **72** | found |
